...
# 导入组件
from components.model import create_rtdetr_model
from components.visualizer import create_visualizer
...
def main():
    ...
    config = {
        ...
        'model_path': '/home/kyc/project/RT-DETR/results/component_training/rtdetr_trained.pkl',
        'conf_threshold': 0.3,
        'test_images_dir': '/home/kyc/project/RT-DETR/data/coco2017_50/val2017',
        'save_dir': '/home/kyc/project/RT-DETR/results/component_visualizations'
    }
    ...
    try:
        ...
        if os.path.exists(config['model_path']):
            ...
            print(f"   请先运行train_script.py进行训练")
            return False
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print(f"   确保已经运行train_script.py完成训练")
